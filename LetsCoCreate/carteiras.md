...
flowchart TD
    A(["Chave Privada"]) --> B["Chave Pública #1"] & n1@{ label: "<span style=\"padding-left:\">Chave Pública #2</span>" } & n2@{ label: "<span style=\"padding-left:\"><span style=\"padding-left:\">Chave Pública #3</span></span>" }
    B --> n3["endereço"] 
    n1 --> n6@{ label: "<span style=\"padding-left:\">endereço</span>" } 
    n2 --> n7@{ label: "<span style=\"padding-left:\">endereço</span>" } & n8@{ label: "<span style=\"padding-left:\"><span style=\"padding-left:\">endereço</span></span>" }
